...
$render('partials/admin', 'head', [
    'title' => 'Prévia da galeria ' . $gallery->id . ' - ' . Company::getFullName(),
    'description' => 'Página de pré-visualização da galeria ' . $gallery->id . ' - ' . Company::getShortName(),
    'pageId' => $pageId
]);
                    ...
                    <div class="col-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <img src="<?= $base . $gallery->fileName ?>" class="img-thumbnail rounded me-2 img-fluid w-50" alt="" />
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12 d-flex">
                                        ...
                                        <div class="d-flex flex-column align-items-end">
                                            <time datetime="<?= date('d/m/y H:m:s', strtotime($gallery->createdAt)) ?>">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12 d-flex">
                                        ...
                                        <span><?= $gallery->addedBy ?></span>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-12 d-flex">
                                        <strong class="flex-grow-1">Última atualização</strong>
                                        <time datetime="<?= date('d/m/y H:m:s', strtotime($gallery->updatedAt)) ?>">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12 d-flex">
                                        ...
                                        <span><?= $gallery->lastUpdate ?></span>
                                    </div>
                                </div>

                                <div class="row mt-5">
                                    <div class="col-sm-12 d-flex flex-column gap-2">
                                        <a href="<?= $base . 'admin/gallery/' . $gallery->id . '/edit' ?>" class="btn btn-success waves-effect w-100">
                                            Editar galeria <i class="mdi mdi-pencil"></i>
                                        </a>
                                        <a href="<?= $base . 'admin/gallery' ?>" class="btn btn-secondary waves-effect w-100">
                                            Voltar para galerias <i class="mdi mdi-image"></i>
                                        </a>
                                    </div>
                                </div>
