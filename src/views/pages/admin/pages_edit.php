...
$render('partials/admin', 'head', [
    'title' => 'Editar página de SEO - ' . $page->title . ' - ' . Company::getFullName(),
    'description' => 'Página de edição para a página de SEO - ' . $page->title . ' - ' . Company::getShortName(),
    'pageId' => $pageId
]);
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <?php $render('partials/admin', 'breadcrumbs', [
                            'title' => 'Editar página de SEO ' . $page->title,
                            'breadcrumbItem' => [
                ...
                <form action="<?= $base . 'admin/pages/' . $page->slug . '/edit' ?>" class="row" method="POST" enctype="multipart/form-data">
                    <div class="col-9">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Prévia da página de SEO - <?= $page->title ?></h4>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="page-title" class="form-control" type="text" placeholder="Digite o título da página" name="title" value="<?= $page->title ?>" data-autofill-url="input" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="h1" class="col-sm-2 col-form-label">H1</label>
                                    <div class="col-sm-10">
                                        <input id="h1" class="form-control" type="text" placeholder="Digite o H1 da página" name="h1" value="<?= $page->h1 ?>" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="alt-title" class="col-sm-2 col-form-label">Alt-title</label>
                                    <div class="col-sm-10">
                                        <input id="alt-title" class="form-control" type="text" placeholder="Digite o alt-title das imagens" name="alt_title" value="<?= $page->altTitle ?>" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="description" class="col-sm-2 col-form-label">Description</label>
                                    <div class="col-sm-10">
                                        <input id="description" class="form-control" type="text" placeholder="Digite a meta description da página" name="description" min="1" max="160" value="<?= $page->description ?>" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="slug" class="col-sm-2 col-form-label">Slug</label>
                                    <div class="col-sm-10">
                                        <input id="slug" class="form-control" type="text" placeholder="Digite a slug da página (url)" name="slug" value="<?= $page->slug ?>" data-autofill-url="output" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <input type="hidden" name="default_image" value="<?= $page->image ?>" />
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="able" id="pageAble" <?= $page->able == 1 ? 'checked' : '' ?> value="1">
                                                <label class="form-check-label" for="pageAble">
                                                    Sim
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="able" id="pageDisable" <?= $page->able == 0 ? 'checked' : '' ?> value="0">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 d-flex flex-column gap-2">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light me-1 w-100">
                                            Salvar página de SEO <i class="mdi mdi-content-save"></i>
                                        </button>
                                        <a href="<?= $base . 'admin/pages/' . $page->slug . '/delete' ?>" class="btn btn-danger waves-effect w-100" onclick="return confirm('Deseja continuar com a exclusão da página de SEO <?= $page->slug ?>?\nClique em OK para continuar ou em Cancelar para desistir.')">
                                            Deletar página de SEO <i class="mdi mdi-trash-can"></i>
                                        </a>
