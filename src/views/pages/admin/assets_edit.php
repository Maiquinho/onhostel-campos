...
$render('partials/admin', 'head', [
    'title' => 'Editar asset ' . $asset->id . ' - ' . Company::getFullName(),
    'description' => 'Página de edição do asset ' . $asset->id . ' - ' . Company::getShortName(),
    'pageId' => $pageId
]);
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="<?= $base . 'admin/assets/' . $asset->id . '/edit' ?>" class="row" method="POST" enctype="multipart/form-data">
                    <div class="col-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="url" class="form-control" type="text" placeholder="Digite aqui uma legenda para o arquivo." name="legend" value="<?= $asset->legend ?>" />
                                    </div>
                                </div>

                                <input type="hidden" name="last_update" value="<?= $loggedUser->username ?>" />
                                <input type="hidden" name="default_file" value="<?= $asset->fileName ?>" />
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="able" id="file-able" <?= $asset->able == 1 ? 'checked' : '' ?> value="1">
                                                <label class="form-check-label" for="file-able">
                                                    Sim
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="able" id="file-disable" <?= $asset->able == 0 ? 'checked' : '' ?> value="0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-12">
                                        <img src="<?= $base . $asset->fileName ?>" class="img-thumbnail rounded me-2 img-fluid" alt="" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 d-flex flex-column gap-2">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light me-1 w-100">
                                            Salvar Asset <i class="mdi mdi-content-save"></i>
                                        </button>
                                        <a href="<?= $base . 'admin/assets/' . $asset->id . '/delete' ?>" class="btn btn-danger waves-effect w-100" onclick="return confirm('Deseja continuar com a exclusão do asset <?= $asset->id ?>?\nClique em OK para continuar ou em Cancelar para desistir.')">
                                            Deletar Asset <i class="mdi mdi-trash-can"></i>
                                        </a>
