(function () {
    ...
    }else if(window.location.hostname == 'sitespublinet1.com.br'){
    ...
    var usersWhats = [
        { Name: "Jagb Confecções", Phone: "+55 11 97888-1070", UnmaskedPhone: "5511978881070", Message: "Olá, vi seu site e gostaria de saber mais sobre seus produtos!", ButtonText: null, Photo: baseURL + "assets/site/images/favicon.png" },
    ];
    var usersHTML = "";
    ...
    var HTML =
        '<button class="wc--button-fab"><div class="wc--icon"><img src="'+ baseURL +'assets/site/images/whatsapp-brands.svg" alt="icon-chat" width="31px" /></div></button><div class="wc--float-ballon"><button class="wc-float-ballon--button-close">+</button><span class="wc--float-ballon--title">Conversar pelo WhatsApp</span><div class="wc--float-ballon--content"><p class="wc--float-ballon--text">' +
        CTA +
