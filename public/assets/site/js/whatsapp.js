(function () {
    "use strict";
    // fazer parte de request da API config com o número de telefone atualizado
    // function getWhatsappNumber() {
    //     let number1 = '234354454';
    //     let number2 = '234354454';

    //     function formatWhatsappNumber(whatsappNumberString) {
    //         var cleaned = ('' + whatsappNumberString).replace(/\D/g, '');
    ...
    //     return [formatWhatsappNumber(number1), formatWhatsappNumber(number2)]
    // }
    var baseURL;
    if(window.location.hostname == 'localhost'){
        baseURL = window.location.origin + '/' + window.location.href.split('/')[3] + '/';
    }else if(window.location.hostname == 'michaelmatheusprojetos.com.br'){
        baseURL = window.location.origin + '/' + window.location.href.split('/')[3] + '/' + window.location.pathname.split('/')[2] + '/';
    }else{
        baseURL = window.location.origin + '/';
    }
    var tipography = "Ubuntu";
    var CTA = "Gostaria de fazer uma reserva? Chame no WhatsApp!";
    var description = "";
    var btnText = "Iniciar conversa";
    var usersWhats = [
        { Name: "Recepção/Reservas", Phone: "+55 12 97403-7217", UnmaskedPhone: "5512974037217", Message: "Olá, vi seu site e gostaria de fazer uma reserva no Hostel!", ButtonText: null, Photo: baseURL + "assets/site/img/bell-concierge-solid.svg" },
    ];
    var usersHTML = "";
    ...
    var style =
        ...
        tipography +
        ",sans-serif}#whatsclub-widget>.wc--button-fab{display:flex;align-items:center;justify-content:center;min-width:64px;min-height:64px;max-height:64px;position:absolute;bottom:0;right:0;outline:0;border-radius:100%;border:none;background:#25d366!important;box-shadow:0 12px 18px rgba(37,211,102,.24);transition:all .4s ease}#whatsclub-widget>.wc--button-fab:hover{bottom:6px;box-shadow:0 12px 24px rgba(37,211,102,.72);transition:all .4s ease}#whatsclub-widget>.wc--button-fab>.wc--icon{display:flex;align-items:center;justify-content:center}#whatsclub-widget>.wc--button-fab>.wc--icon>.wc--icon--svg{fill:#fff!important}#whatsclub-widget>.wc--button-fab---open{background:#111b21!important;transition:all .4s ease}#whatsclub-widget>.wc--button-fab---open>.wc--icon>.wc--icon--svg{fill:#25d366!important;transition:all .4s ease}#whatsclub-widget>.wc--float-ballon{position:absolute;display:flex;flex-direction:column;width:260px;max-width:calc(100vw - 40px - 64px - 12px - 10vw);bottom:16px;right:calc(64px + 12px);padding:0;background:#222e35!important;box-shadow:0 12px 18px rgba(0,0,0,.12),0 -6px 64px rgba(0,0,0,.06);border-radius:12px;transition:all .4s ease;opacity:0;transform:translateY(40px);animation:showBallon .6s ease forwards;animation-delay:2s}#whatsclub-widget>.wc--float-ballon.wc--float-ballon---open{width:320px;max-height:calc(100vh - 40px - 10vh);transition:all .4s ease;animation-delay:0s}#whatsclub-widget>.wc--float-ballon.wc--float-ballon---close{display:none}#whatsclub-widget>.wc--float-ballon>.wc-float-ballon--button-close{position:absolute;width:24px;height:24px;display:flex;align-items:center;justify-content:center;background:0 0;border:none;outline:0;right:6px;top:4px;opacity:.38;color:#8788ab;font-size:21px;transform:rotate(45deg);transform:-webkit-rotate(45deg)}#whatsclub-widget>.wc--float-ballon>.wc-float-ballon--button-close .wc-float-ballon--button-close--icon{width:100%;height:100%}#whatsclub-widget>.wc--float-ballon>.wc-float-ballon--button-close:hover{opacity:.8}#whatsclub-widget>.wc--float-ballon:not(:hover)>.wc-float-ballon--button-close{opacity:0}#whatsclub-widget>.wc--float-ballon.wc--float-ballon---open>.wc-float-ballon--button-close{display:none}#whatsclub-widget>.wc--float-ballon>.wc--float-ballon--ass{display:none}#whatsclub-widget>.wc--float-ballon:not(.wc--float-ballon---open)>.wc--float-ballon--ass{display:none}#whatsclub-widget>.wc--float-ballon>.wc--float-ballon--content{display:flex;flex-direction:column;flex-grow:1;max-height:calc(100vh - 40px - 10vh - 64px);overflow:auto;padding:16px;justify-content:flex-start}#whatsclub-widget>.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--text{width:100%;color:#f4f4f4;font-size:16px;line-height:20px;margin:0}#whatsclub-widget>.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--text--small{font-size:14px;line-height:19px;display:block}#whatsclub-widget>.wc--float-ballon:not(.wc--float-ballon---open)>.wc--float-ballon--content>.wc--float-ballon--text--small{display:none}#whatsclub-widget>.wc--float-ballon---open>.wc--float-ballon--content>.wc--float-ballon--text{margin:0 0 24px 0}#whatsclub-widget>.wc--float-ballon>.wc--float-ballon--title{background:#25d266!important;height:54px;overflow:hidden;border-radius:12px 12px 0 0;display:flex;align-items:center;padding:0 16px;color:#fff!important;font-size:18px;border-bottom:solid 1px #8788ab}#whatsclub-widget>.wc--float-ballon:not(.wc--float-ballon---open)>.wc--float-ballon--title{display:none}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user{display:flex;background:#111b21;box-shadow:0 4px 8px rgba(0,0,0,.12);border-radius:2px;margin-bottom:16px}#whatsclub-widget>.wc--float-ballon:not(.wc--float-ballon---open)>.wc--float-ballon--content>.wc--float-ballon--user{display:none}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user:last-child{margin-bottom:0}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user---thumb{width:48px;height:48px;object-fit:cover;margin:12px 0 0 12px}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user--content{flex-grow:1;padding:12px}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user--content>.wc--float-ballon--user--content---name{font-size:16px;font-weight:600;color:#}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user--content>.wc--float-ballon--user--content---phone{font-size:12px;color:#8696a0;display:block}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user--content>.wc--float-ballon--user--content---button{display:flex;width:100%;height:36px;background:#075e54!important;color:#fff!important;align-items:center;justify-content:center;border-radius:4px;font-size:14px;line-height:1;margin-top:8px;box-shadow:0 8px 16px rgba(7,94,84,.24);transition:all .3s ease}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user--content>.wc--float-ballon--user--content---button:hover{box-shadow:0 12px 24px rgba(7,94,84,.38);transform:translateY(-6px);transition:all .3s ease}#whatsclub-widget>.wc--float-ballon:not(.wc--float-ballon---open)>.wc--button-whatsapp{display:none}@keyframes showBallon{from{opacity:0;transform:translateY(40px)}to{opacity:1;transform:translateY(0)}}@keyframes zoomEffect{0%{transform:scale(1.2)}50%{transform:scale(1.1)}100%{transform:scale(1.2)}}#whatsclub-widget>.wc--button-fab::after{content:'';position:absolute;display:block;width:64px;height:64px;border-radius:100%;background:#25d36654;z-index:-1;transform:scale(1);animation-name:zoomEffect;animation-duration:1s;animation-timing-function:ease-in-out;animation-fill-mode:forwards;animation-iteration-count:infinite}@media screen and (max-width:980px){#whatsclub-widget{bottom:20px;right:20px}#whatsclub-widget>.wc--float-ballon{max-width:calc(100vw - 20px - 64px - 12px - 10vw)}}@media screen and (max-width:400px){#whatsclub-widget>.wc--button-fab{min-width:54px;max-width:54px;min-height:54px;max-height:54px}#whatsclub-widget>.wc--float-ballon{max-width:calc(100vw - 20px - 54px - 8px - 5vw);right:calc(54px + 8px)}#whatsclub-widget>.wc--float-ballon>.wc--float-ballon--title{font-size:15px}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user{flex-wrap:wrap}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user---thumb{width:24px;height:24px}#whatsclub-widget>.wc--float-ballon.wc--float-ballon>.wc--float-ballon--content>.wc--float-ballon--user>.wc--float-ballon--user--content{width:100%;padding-top:4px}}";
